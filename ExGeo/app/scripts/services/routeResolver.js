    ...
    var routeResolver = function () {
        ...
        this.routeConfig = function () {
            var viewsDirectory = 'app/views/',
                controllersDirectory = 'app/scripts/controllers/',
        ...
        this.route = function (routeConfig) {
            ...
            var resolve = function (baseName, path, secure) {
                ...
                // routeDef.url = "/" + baseName.toLowerCase();
                routeDef.templateUrl = routeConfig.getViewsDirectory() + path + baseFileName + '.html' + version;
                routeDef.controller = baseName + 'Controller';
                routeDef.requiresLogin = (secure) ? secure : false;
                routeDef.resolve = {
