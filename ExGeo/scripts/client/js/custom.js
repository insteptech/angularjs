...
(function($) {
    ...
    $('body').videoBG({
        position:"fixed",
		zIndex:0,
		mp4: 'scripts/client/video/video.mp4',
		ogv: 'scripts/client/video/video.ogv',
		webm: 'scripts/client/video/video.webm',
		poster: 'scripts/client/video/video.jpg',
		opacity:1,
		fullscreen:true
	});
...
jQuery(document).ready(function($) {
    ...
    var $marker_url = (is_internetExplorer11) ? 'css/client/images/map-marker.png' : 'css/client/images/map-marker.svg';
